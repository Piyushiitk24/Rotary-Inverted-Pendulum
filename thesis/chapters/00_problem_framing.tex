...
\begin{itemize}
  \item \textbf{Acceleration-input control matched to stepper actuation.} We model and control the system using commanded base/arm acceleration $u=\ddot{\theta}$ (not torque), matching the implemented actuation pipeline (acceleration integrated to velocity and commanded to the stepper).
