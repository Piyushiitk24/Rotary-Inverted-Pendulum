...
\subsection{What is used later}\label{what-is-used-later}
...
\tightlist
\item
  Nonlinear upright relation: \[\ddot\alpha = A\sin\alpha + \sin\alpha\cos\alpha\,\dot\theta^2 - B\cos\alpha\,\ddot\theta\]
\item
  Linearized upright relation: \[\ddot\alpha = 100.8\,\alpha - 1.952\,\ddot\theta\]
\item
  Stepper conversion used in firmware and plots: \[k_s = 4.444\ \text{step/deg}\]
\end{itemize}

So the main constants passed forward from this chapter are {[} A = 100.8,\qquad B = 1.952,\qquad k\_s = 4.444~\text{step/deg}. {]}
