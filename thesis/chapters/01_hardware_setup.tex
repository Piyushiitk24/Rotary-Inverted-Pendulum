...
\[
k_s \approx \frac{1600}{360} = 4.444\ \text{steps/degree},
\]
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    \midrule
    Stepper driver STEP/DIR/EN & D11 / D6 / D7 & step/direction/enable signals \\
    I\textsuperscript{2}C bus (SDA/SCL) & D20 / D21 & shared by multiplexer and sensors \\
    I\textsuperscript{2}C multiplexer channels & ch0 / ch1 & pendulum encoder / base encoder \\
    \bottomrule
  \end{tabular}
\end{table}
