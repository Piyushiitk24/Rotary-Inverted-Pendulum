...
\begin{itemize}
  ...
  \item $\alpha(t)$: pendulum angle about the bearing-supported pivot axis (aligned with the arm/radial direction), measured from the upright configuration ($\alpha=0$ upright).
\end{itemize}
...
\begin{itemize}
  ...
  \item commanded base acceleration $u$ (\si{\step\per\second\squared}),
  \item commanded step rate $\dot{\theta}_{\mathrm{cmd}}$ (\si{\step\per\second}),
